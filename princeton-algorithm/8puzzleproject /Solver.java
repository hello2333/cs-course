...
public class Solver {
    ...
    private class SearchNodeComparator implements Comparator<SearchNode> {
        ...
        public int compare(SearchNode o1, SearchNode o2) {
            return o1.manhattenPriority() - o2.manhattenPriority();
        }
    }
    ...
    public Solver(Board initial) {
        MinPQ<SearchNode> frontier = new MinPQ<>(new SearchNodeComparator());
        MinPQ<SearchNode> frontierTwin = new MinPQ<>(new SearchNodeComparator());
    ...
    public int moves() {
        return isSolvable() ? result.moves : -1;
    }
