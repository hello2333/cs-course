...
public class Board {
    ...
    private Board updateTwin() {
        int newRow1 = blankRow;
        int newCol1 = (blankCol + 1) % dimension();

        int newRow2 = (blankRow + 1) % dimension();
        int newCol2 = blankCol;
